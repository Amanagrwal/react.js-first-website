...
import Img from "../src/image/images.png"
          ...
          <div className="col-11 mx-auto">
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
              <div className="container-fluid">
                <NavLink className="navbar-brand" to="/">AMAN MANGAL</NavLink>
                <button
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ml-auto mb-2 mb-lg-0 custom-margin-left">
                    ...
                    <li className="nav-item">
                     ...
                     <img src={Img} alt='img' className='local-img'/>
                  </ul>
                </div>
              </div>
            </nav>
